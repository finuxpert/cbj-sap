...
export default function ToolSt03nImpactV2() {
  ...
  const analyze = async (nextFiles = files) => {
    ...
    try {
      ...
      setStatus('ST03N analysis complete. Select/create a case, then click Save to Case History when ready.')
    } catch (error) {
