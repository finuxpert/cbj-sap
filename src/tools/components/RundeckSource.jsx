  ...
  return <section className="rundeckPanel" aria-label="SAP performance monitoring" aria-live="polite">
    ...
    <details className="rundeckHistory">
      ...
      <div className="rundeckHistoryTableWrap">
        <table>
          <thead><tr><th>Run</th><th>Time WIB</th><th>Servers</th><th>Status</th></tr></thead>
          <tbody>
            ...
            {!history.length && <tr><td colSpan="4">No Rundeck run history yet.</td></tr>}
          </tbody>
        </table>
      </div>
    </details>
    ...
    <details className="rundeckPlatformHealth">
      <summary>SPHERE Infra Health <StatusPill value={platformState} /><span>Server, DB, storage, backup</span></summary>
      <div className="rundeckPlatformTableWrap">
        <table className="rundeckPlatformTable">
          ...
          <tbody>
            ...
            <tr><td>Releases</td><td>{releaseState}</td><td>{platform?.releases ? `${platform.releases.backend.count} backend · ${platform.releases.web.count} web · retain ${platform.releases.backend.retain}` : '—'}</td></tr>
          </tbody>
        </table>
      </div>
    </details>
