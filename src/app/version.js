...
export const APP_PREVIOUS_VERSION = '1.16.0'
...
export const APP_DISPLAY_VERSION = `v${APP_VERSION}${APP_ENV === 'dev' ? '-dev' : ''}${APP_BUILD ? ` · ${APP_BUILD}` : ''}`
export const LOG_ANALYTICS_ENGINE = 'legacy-final-ui-semantics-v3.6.4'
export const LOG_UI_REVISION = 'single-scroll-inspector-v1.16.1'
