...
function LogTabContent({ activeTab, analysis }) {
  ...
  if (activeTab === 'Error Analysis') return <><ErrorRankingTable rows={analysis.errorGroups || []} /><BarChart title="Error Code Distribution (Hits)" subtitle="Occurrences from uploaded evidence" rows={errorHits} valueKey="hits" tone="crit" /></>
